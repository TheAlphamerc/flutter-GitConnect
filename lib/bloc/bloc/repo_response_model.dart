...
class RepositoryResponse {
  ...
  factory RepositoryResponse.fromRawJson(String str) =>
...
class RepositoryModel {
  ...
  factory RepositoryModel.fromJson(Map<String, dynamic> json) =>
      RepositoryModel(
        ...
        watchers:
            json["watchers"] == null ? null : Issues.fromJson(json["watchers"]),
        defaultBranchRef: json["defaultBranchRef"] == null
            ? null
            : DefaultBranchRef.fromJson(json["defaultBranchRef"]),
        pullRequests: json["pullRequests"] == null
            ? null
            : Issues.fromJson(json["pullRequests"]),
        ...
        shortDescriptionHtml: json["shortDescriptionHTML"] == null
            ? null
            : json["shortDescriptionHTML"],
        stargazers: json["stargazers"] == null
            ? null
            : Issues.fromJson(json["stargazers"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "defaultBranchRef":
            defaultBranchRef == null ? null : defaultBranchRef.toJson(),
        "pullRequests": pullRequests == null ? null : pullRequests.toJson(),
        "issues": issues == null ? null : issues.toJson(),
        "mirrorUrl": mirrorUrl,
        "primaryLanguage":
            primaryLanguage == null ? null : primaryLanguage.toJson(),
        "resourcePath": resourcePath == null ? null : resourcePath,
        "shortDescriptionHTML":
            shortDescriptionHtml == null ? null : shortDescriptionHtml,
...
class DefaultBranchRef {
  ...
  factory DefaultBranchRef.fromRawJson(String str) =>
      DefaultBranchRef.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DefaultBranchRef.fromJson(Map<String, dynamic> json) =>
      DefaultBranchRef(
        name: json["name"] == null ? null : json["name"],
      );
